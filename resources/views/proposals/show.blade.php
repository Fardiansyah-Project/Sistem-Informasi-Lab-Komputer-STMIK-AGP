            ...
            <table class="w-full">
                <thead>
                    <tr class="border-b border-slate-100">
                        ...
                        <th class="text-left px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Nama Barang</th>
                        <th class="text-center px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Jumlah</th>
                        <th class="text-left px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Ruang Tujuan</th>
                        <th class="text-left px-6 py-3 text-xs font-semibold text-slate-500 uppercase tracking-wider">Keterangan</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-slate-50">
                    @foreach($proposal->details as $index => $detail)
                        <tr class="hover:bg-slate-50/50 transition-colors">
                            ...
                            <td class="px-6 py-3 text-sm text-slate-700 text-center font-semibold">{{ $detail->jumlah }}</td>
