    ...
    @if($selectedLab)
        <div class="bg-white rounded-2xl border border-slate-200/80 overflow-hidden animate-slide-down">
            <div class="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
                ...
                <a href="{{ route('reports.inventories.pdf', ['laboratorium_id' => request('laboratorium_id')]) }}" class="inline-flex items-center gap-1.5 text-xs font-semibold text-indigo-600 hover:text-indigo-700 transition-colors print:hidden">
